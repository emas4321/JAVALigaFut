...
<div class="container-fluid">
    ...
    <table id="tablePartido" class="table table-bordered ">
        ...
        <%
        LinkedList<Partido>listaP=(LinkedList<Partido>)session.getAttribute("listaP");			
			for(Partido listP : listaP) {
				EquipoLogic equipoL= new EquipoLogic();
				Equipo e1=equipoL.getOne(listP.getIdEquipo1()); 
				Equipo e2=equipoL.getOne(listP.getIdEquipo2()); 
        ...
        <tr>
            ...
            <th><%=listP.getNumCancha() %></th>
             <th><form action="ControladorRePartido" method=post>
